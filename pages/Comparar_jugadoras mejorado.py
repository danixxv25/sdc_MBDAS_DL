...
# Función para calcular la similitud coseno entre dos jugadoras
def calcular_similitud(metrics1, metrics2, position_metrics, position):
    ...
    # Crear vectores para la similitud coseno
    vector1 = [metrics1.get(m, 0) for m in common_metrics]
    vector2 = [metrics2.get(m, 0) for m in common_metrics]
