    ...
    if selected_player:
        ...
        with col3:
            ...
            if not df_view.empty:
                ...
                if jugadora_info is not None and 'Birth_Date' in jugadora_info.columns and not pd.isna(jugadora_info['Birth_Date'].iloc[0]):
                ...
                if jugadora_info is not None and 'Height' in jugadora_info.columns and not pd.isna(jugadora_info['Height'].iloc[0]):
